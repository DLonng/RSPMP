...
*/
    ...
    */
    ...
    double clip_height = 10.0;
    double clip_near_dist = 0.1;
...
/*
    ...
    // 同条射线上邻近两点的坡度阈值，单位度
    double local_slope_threshold = 5.0; // 5.0
    // 整个地面的坡度阈值，单位度
    double general_slope_threshold = 3.0; // 3.0
 ...
 */   
    ...
    //auto in_cloud_msg = in_cloud_clipped;
